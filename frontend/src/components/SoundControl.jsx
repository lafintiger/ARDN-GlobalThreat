...
function SoundControl({ 
  ...
  return (
    ...
    >
      ...
      <button 
        className={`voice-input-toggle ${voiceInputEnabled ? 'enabled' : 'disabled'}`}
        onClick={handleVoiceInputClick}
        title={voiceInputEnabled ? 'Disable voice input' : 'Enable voice input (talk to ARDN)'}
      >
        {voiceInputEnabled ? (
          <span className="voice-input-icon">🎤</span>
        ) : (
          <span className="voice-input-icon muted">🎤</span>
        )}
      </button>
